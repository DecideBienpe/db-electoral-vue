    ...
    <div class="partido-ranking">
      <div class="partido" v-for="partido in graph_data" :key="partido.name">
        <div class="partido-name text-center">
          <a
            class="text-center"
            :href="`#/partidos/${render_logo(partido.Partido)}`"
          >
            <v-img
              contain
        ...
        <div class="graph">
          <div class="graph-item" :class="{ active: field == 'PromedioEdad' }">
            ...
            <div>
              ...
              <div
                class="percent promedio-edad"
                :style="
                  `width: ${calcScale(
                    partido.PromedioEdad,
                    'PromedioEdad',
                    85,
                    150
                  )}px`
          ...
          <div class="graph-item" :class="{ active: field == 'Joven' }">
            ...
            <div>
              ...
              <div
                class="percent joven"
                :style="
                  `width: ${calcScale(partido.Joven, 'Joven', 85, 150)}px`
                "
              ></div>
            </div>
          </div>
          <div class="graph-item" :class="{ active: field == 'Mayor' }">
            ...
            <div>
              ...
              <div
                class="percent mayor"
                :style="
                  `width: ${calcScale(partido.Mayor, 'Mayor', 85, 150)}px`
                "
              ></div>
            </div>
          </div>
          <div class="graph-item" :class="{ active: field == 'PromedioIngr' }">
            ...
            <div>
              ...
              <div
                class="percent ingresos"
                :style="
                  `width: ${calcScale(
                    partido.PromedioIngr,
                    'PromedioIngr',
                    550000,
                    150
                  )}px`
          ...
          <div class="graph-item" :class="{ active: field == 'PExperiencia' }">
            ...
            <div>
              ...
              <div
                class="percent experiencia"
                :style="
                  `width: ${calcScale(
                    partido.PExperiencia,
                    'PExperiencia',
                    100,
                    100
                  )}%`
          ...
          <div class="graph-item" :class="{ active: field == 'Sentencia' }">
            <label>Sentencias</label>
            <div>
              <span
                >{{ partido.DeudoresSunat }}
                {{
                  partido.DeudoresSunat != 1 ? `sentenciados` : `sentenciado`
                }}</span
              >
              <div
                class="percent sentencias"
                :style="
                  `width: ${calcScale(
                    partido.Sentencia,
                    'Sentencia',
          ...
          <div class="graph-item" :class="{ active: field == 'DeudoresSunat' }">
            <label>Deudores de la sunat</label>
            <div>
              <span
                >{{ partido.DeudoresSunat }}
                {{ partido.DeudoresSunat != 1 ? `deudores` : `deudor` }}</span
              >
              <div
                class="percent deudores"
                :style="
                  `width: ${calcScale(
                    partido.DeudoresSunat,
                    'DeudoresSunat',
          ...
          <div class="graph-item" :class="{ active: field == 'Golondrinos' }">
            <label>Golondrinos</label>
            <div>
              <span
                >{{ partido.Golondrinos }}
                {{
                  partido.Golondrinos != 1 ? `golondrinos` : `golondrino`
                }}</span
              >
              <div
                class="percent golondrinos"
                :style="
                  `width: ${calcScale(
                    partido.Golondrinos,
                    'Golondrinos',
          ...
          <div class="graph-item" :class="{ active: field == 'Vacunado' }">
            ...
            <div>
              <span
                >{{ partido.Vacunado }}
                {{ partido.Vacunado > 1 ? `vacunados` : `vacunado` }}</span
              >
              <div
                class="percent golondrinos"
                :style="
                  `width: ${calcScale(partido.Vacunado, 'Vacunado', 10, 150)}px`
                "
              ></div>
            </div>
          </div>
          ...
          <div class="graph-item" :class="{ active: field == 'Pmujeres' }">
            ...
            <div>
              ...
              <div
                class="percent mujeres"
                :style="
                  `width: ${calcScale(partido.Pmujeres, 'Pmujeres', 100, 100)}%`
                "
              ></div>
            </div>
          </div>
          ...
          <div class="graph-item" :class="{ active: field == 'Vacancia' }">
            ...
            <div>{{ partido.Vacancia }}</div>
          </div>
          <div
            class="graph-item"
            :class="{ active: field == 'TipoDemocracia' }"
          >
            <label>Tipo democracia</label>
            <div>{{ partido.TipoDemocracia }}</div>
          </div>
        </div>
      </div>
    </div>
